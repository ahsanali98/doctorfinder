...
const BookVidScreen2 = ({ navigation }) => {
  return (
      ...
      <View style={{ alignItems: 'center' }}>
        ...
        <View style={{ backgroundColor: '#fff', marginTop: 10, height: 90, width: 350 }}>
          ...
          <Text style={{ fontSize: 16, paddingLeft: 5, color: 'grey', marginTop: 1 }}>
            Dr. Aisha Ahmed completed her specialization from DOW Medical College, Karachi.
        ...
        <TouchableOpacity onPress={() => navigation.navigate('BookVidScreen3')}
          style={{
