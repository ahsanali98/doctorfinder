...
const AppointCHScreen1 = ({ navigation }) => {
  return (
    <View style={{ flex: 1, backgroundColor: '#EAEDF2' }}>
      <View style={{ flexDirection: 'row' }}>
        ...
        <Text style={{ paddingLeft: 2, paddingTop: 30, marginTop: 0, fontSize: 30, fontWeight: 'bold' }} >
      ...
      <View style={{ alignItems: 'center' }}>
        <View style={{ flexDirection: 'row', backgroundColor: '#fff', marginTop: 10, height: 140, width: 350 }}>
          ...
          <View>
            <Text style={{ fontSize: 25, paddingLeft: 20, paddingTop: 20 }}>
              Dr. Asma Zain{"\t"}{"\t"}<MaterialCommunityIcons name="delete" size={24} color="black" />
            </Text>
            ...
            <Text style={{ fontSize: 20, paddingLeft: 15, paddingTop: 5, color: 'grey' }}>
        ...
        <View style={{ flexDirection: 'row', backgroundColor: '#fff', marginTop: 10, height: 140, width: 350 }}>
          ...
          <View>
            <Text style={{ fontSize: 25, paddingLeft: 20, paddingTop: 20 }}>
              Dr. Isha Ali{"\t"}{"\t"}{"\t"}{"\t"}<MaterialCommunityIcons name="delete" size={24} color="black" />
            </Text>
            <Text style={{ fontSize: 15, paddingLeft: 20, paddingTop: 0, color: 'green' }}>
              Cardiologist
            </Text>
      ...
      <View style={{
        ...
        alignItems: 'center', marginTop: 182, height: 60, width: 380, borderWidth: 1
      }}>
        <TouchableOpacity>
          <Text>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('AppointCHScreen2')}>
          <Text>
            <Ionicons name="videocam" size={50} color="grey" />
          </Text>
        </TouchableOpacity>
...
export default AppointCHScreen1