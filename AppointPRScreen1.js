...
const AppointPRScreen1 = ({ navigation }) => {
  return (
    <View style={{ flex: 1, backgroundColor: '#EAEDF2' }}>
      ...
      <View style={{ alignItems: 'center' }}>
        <View style={{ flexDirection: 'row', backgroundColor: '#fff', marginTop: 10, height: 170, width: 350 }}>
          ...
          <View>
            ...
            <Text style={{ fontSize: 25, paddingLeft: 20, paddingTop: 5, color: 'black', fontWeight: 'bold' }}>
              PENDING
            </Text>
          </View>
        </View>
      ...
      <View style={{
        ...
        alignItems: 'center', marginTop: 122, height: 60, width: 380, borderWidth: 1
      }}>
        <TouchableOpacity>
          <Text>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('AppointPRScreen2')}>
          <Text>
...
export default AppointPRScreen1